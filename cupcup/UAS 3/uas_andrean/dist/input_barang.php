...
<td>
<button><input type="submit" class="btn btn-primary"name="Save" value="Simpan"></button>
</td>
</table>
</form><input type='button'value='Tambah kategori'onClick='top.location="input_kategori.php"'class='btn btn-primary btn-sm'>
